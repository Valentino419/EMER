...
<body>
    <div class="container">
        <h1 class="text-center mb-4">Gestion Usuarios</h1>
        ...
        <form action="{{ route('user.index') }}" method="GET" class="mb-4">
            <div class="input-group">
                ...
                @if (request('search'))
                    <a href="{{ route('user.index') }}" class="btn btn-secondary ms-2">Limpiar</a>
                @endif
            </div>
        </form>
        ...
        @else
            <p class="text-center text-muted mb-2">
                Mostrando {{ $users->firstItem() }} al {{ $users->lastItem() }} de
            ...
            <div class="d-flex flex-column align-items-center mt-4">
                ...
                @if ($users->total())
                    <p class="text-muted mb-2">
                        Mostrando {{ $users->firstItem() }} al {{ $users->lastItem() }}
