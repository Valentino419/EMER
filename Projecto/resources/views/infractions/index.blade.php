    ...
    <div class="container mt-4">
        ...
        <h2 class="mb-4">
            @if (request('car_plate'))
                Infracciones de <strong>{{ strtoupper(request('car_plate')) }}</strong>
            @elseif (Auth::user()->role->name === 'inspector' || Auth::user()->role->name === 'admin')
        ...
        @if (!request('car_plate'))
            ...
            @if (request('car_plate'))
                <div class="mb-3">
                    <a href="{{ route('infractions.index') }}" class="btn btn-secondary btn-sm">
                                ...
                                <td colspan="6" class="text-center py-5">
                                    <div class="bg-light rounded-3 p-5 shadow-sm border border-danger">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
                                            fill="#dc3545" class="bi bi-x-circle" viewBox="0 0 16 16">
                                            <path
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="bg-light rounded-3 p-5 shadow-sm border border-warning">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
                                            fill="#ffc107" class="bi bi-car-front" viewBox="0 0 16 16">
                                            <path
                                                d="M4 9a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm10 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM6 8a1 1 0 0 0 0 2h4a1 1 0 1 0 0-2H6ZM4.5 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 .5.5v3h-2V3H7v2.5H5v-3Z" />
                                            <path
                                                d="M2 13.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-1Z" />
                                        </svg>
                                        <h5 class="text-warning fw-bold mt-3">Patente no registrada</h5>
                                        <p class="text-muted">
                                            <strong>{{ strtoupper(request('search')) }}</strong> no está en el
                                            sistema.<br>
                                            <small>Se creará al registrar la infracción.</small>
                                        </p>
                                        <button class="btn btn-danger mt-3" data-bs-toggle="modal"
                                            data-bs-target="#infraccionModal"
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        <div class="bg-light rounded-3 p-5 shadow-sm border border-success">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
                                                fill="#28a745" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                                <path
                                                    d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                                            </svg>
                                            <h5 class="text-success fw-bold mt-3">Vehículo con estacionamiento ACTIVO
                                            </h5>
                                            <div class="text-start mt-3">
                                                <p><strong>Patente:</strong> {{ $car->car_plate }}</p>
                                                <p><strong>Zona:</strong>
                                                    {{ $activeParkingSession->zone->name ?? 'N/A' }}</p>
                                                <p><strong>Calle:</strong>
                                                    {{ $activeParkingSession->street->name ?? 'N/A' }}</p>
                                                <p><strong>Finaliza:</strong>
                                                    {{ $activeParkingSession->end_time->format('d/m/Y H:i') }}</p>
                                            </div>
                                            <div class="alert alert-info mt-3">
                                                <strong>No se puede multar:</strong> El vehículo está estacionado
                                                correctamente.
                                            </div>
                                        </div>
                                    </td>
                            ...
                            @else
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        <div class="bg-light rounded-3 p-5 shadow-sm border border-danger">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
                                                fill="#dc3545" class="bi bi-exclamation-triangle-fill"
                                                viewBox="0 0 16 16">
                                                <path
                        ...
                        <tr>
                            <td colspan="{{ Auth::user()->role->name === 'inspector' ? 5 : 6 }}"
                                ...
                                <div class="bg-light rounded-3 p-5 shadow-sm border border-light">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
                                        fill="#6c757d" class="bi bi-inbox" viewBox="0 0 16 16">
                                        <path
                                            d="M4.98 4a.5.5 0 0 0-.39.188L1.54 8H6a.5.5 0 0 1 .5.5v1A1.5 1.5 0 0 1 5 11H1a1.5 1.5 0 0 1-1.5-1.5v-7A1.5 1.5 0 0 1 1 1h5.5a.5.5 0 0 1 0 1H1a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-1A.5.5 0 0 1 6 8h4.54l-3.05-3.812A.5.5 0 0 0 11.98 4H4.98z" />
                                    </svg>
